      ...
      <div className="flex gap-2">
        ...
        <div className="flex flex-col justify-center">
          <div className="flex items-center gap-1">
            <p className="font-bold text-white font-space text-sm">
              {item.name}
            </p>
            <div
              className={`p-0.5 rounded-full bg-white/5 ${categoryConfig.color}`}
            >
...
export default function TechArsenalSection() {
  return (
    ...
    <div
      id="tech-arsenal"
      className="px-4 md:px-16 lg:px-24 xl:px-32 py-20 overflow-hidden"
    >
      {/* HEADER */}
      <SectionTitle
